...
function lunr_search(term) {
    ...
    if(term) {
        ...
        if(results.length>0){
            ...
            document.querySelectorAll('#lunrsearchresults ul')[0].innerHTML = "<li class='lunrsearchresult'>К сожалению, никаких результатов не найдено. Закройте и попробуйте другой поиск!</li>";
        }
    }
    return false;
}
